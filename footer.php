...
<div class="container backgroungimgbottom">
    <div class="row">
        ...
        <div class="col-md-3" style="text-align: center;">
            <a class="navbar-brand footerlogo" href="index.html">
			<img src="<?php if(empty($footer_logo))
			{echo'./wp-content/uploads/2018/08/footer-logo.png';}
			else{echo $footer_logo;} ?>" alt="">
		</a> 
        </div>
    </div>
</div>